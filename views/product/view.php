					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
                                <? if($product->new): ?>
                                    <?= Html::img("@web/images/home/new.png", ['class' => 'newarrival', 'alt' => 'Новинка'])?>
                                <? endif; ?>
                                <? if($product->sale): ?>
                                    <?= Html::img("@web/images/home/sale.png", ['class' => 'newarrival', 'alt' => 'Распродажа'])?>
                                <? endif; ?>
                                <h2><?= $product->name ?></h2>
								<p>Web ID: 1089772</p>
...
Submit
					...
					<div class="recommended_items"><!--recommended_items-->
						...
						<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
                            <? $count = count($hits); $i=0; foreach ($hits as $hit) : ?>
                            <? if($i % 3 == 0):?>
